        ...
        <>
            <section className='flex justify-center items-center py-32'>
                <div className='flex flex-1 flex-col'>
                    <div className='flex md:justify-start justify-center border-b-2 w-full'>
                    ...
                    <div className='flex flex-1 md:flex-row flex-col flex-wrap justify-start items-center mr-3 py-10'>
                        {webSkills.map((skill) => (
                            <div key={skill.id} className='flex flex-1 justify-start items-center flex-col'>
                                ...
                                <h3 className='py-2 md:text-xl text-lg mr-3 flex flex-1 flex-row uppercase'>{skill.content}</h3>
                            </div>
                        ))}
                    </div>
                    <div className='flex border-b-2 w-full mt-10'></div>
                    <div className='flex justify-center items-center w-full my-48'>
                    ...
                    <div className='flex-flex-1 flex-col'>
                        ...
                        <div className='flex justify-center items-center'>
                            <p className='py-3 md:py-10 md:mr-[300px] text-[31px] md:text-6xl'>are Fragile</p>
                        </div>
